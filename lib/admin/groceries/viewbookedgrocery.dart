...
class bokkedgrocery extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection('groceryPayment').orderBy('timestamp', descending: true).snapshots(),
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  title: Text('Grocery: ${payment['groceryName']}',style: TextStyle(fontSize: 25),),
                  subtitle: Column(
