...
class belowadd extends StatefulWidget {
  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<belowadd> {
  ...
  void submitHealthTip() async {
    ...
    await FirebaseFirestore.instance.collection('health_tips2').add({
  ...
  void deleteHealthTip(String id) async {
    await FirebaseFirestore.instance.collection('health_tips2').doc(id).delete();
    ScaffoldMessenger.of(context).showSnackBar(
  ...
  void deleteAllHealthTips() async {
    final collection = FirebaseFirestore.instance.collection('health_tips2');
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text("for people below 75",style: TextStyle(fontFamily: 'Schyler',fontSize: 18),),
