...
class welcomethree extends StatefulWidget {
  ...
  @override
  State<welcomethree> createState() => _doctorState();
}

class _doctorState extends State<welcomethree> {
  @override
            ...
            children: [
              Stack(children: [
                Container(
                  ...
                  color: Colors.yellow,
                  child: Image.asset("assets/images/w3.jpg",fit: BoxFit.cover,),
                ),
                Positioned(
                  top: 550,
                  child: Container(width: 450,height: 310,
                  ...
                  child:Column(children: [
                    SizedBox(height: 40,),
                    Text("Book your Doctor",style: TextStyle(color: Colors.black,fontSize: 30),),
                    Text("Services",style: TextStyle(color: Colors.black,fontSize: 30),),
                    ...
                    Padding(
                      ...
                      child: Column(children: [SizedBox(width: 30,),
                        ...
                        ElevatedButton(
                            ...
                            child: Text("NEXT",style: TextStyle(color: Colors.white),), style: ElevatedButton.styleFrom(
